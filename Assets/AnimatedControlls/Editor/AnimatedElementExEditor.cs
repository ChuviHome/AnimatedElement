...
public class AnimatedElementExEditor : Editor
{
    ...
    private void OnEnable()
    {
        ...
        if (pauseIcon == null) pauseIcon = AssetDatabase.LoadAssetAtPath<Texture>("Assets/AnimatedControlls/Editor/Icons/pause-icon.png");
        if (randomIcon == null) randomIcon = AssetDatabase.LoadAssetAtPath<Texture>("Assets/AnimatedControlls/Editor/Icons/random-icon.png");
        if (waitIcon == null) waitIcon = AssetDatabase.LoadAssetAtPath<Texture>("Assets/AnimatedControlls/Editor/Icons/wait-icon.png");
        if (repeateIcon == null) repeateIcon = AssetDatabase.LoadAssetAtPath<Texture>("Assets/AnimatedControlls/Editor/Icons/repeate-icon.png");
        if (usedIcon == null) usedIcon = AssetDatabase.LoadAssetAtPath<Texture>("Assets/AnimatedControlls/Editor/Icons/used-icon.png");
